# Fundamentals Part One: Fluid Dynamics
...
**Definition**  
The ratio of the density of a fluid to the density of a reference substance, usually water for liquids.

**Formula**

$$
SG = \frac{\rho_{\text{fluid}}}{\rho_{\text{reference}}}
$$
...
**Definition**  
Describes the linear relationship between shear stress and shear rate in a Newtonian fluid.
...
**Mach Number ($M$)**  
The ratio of the speed of an object to the speed of sound in the fluid.
